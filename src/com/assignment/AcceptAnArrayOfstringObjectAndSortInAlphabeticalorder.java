...
public class AcceptAnArrayOfstringObjectAndSortInAlphabeticalorder {
	...
	public static void main(String[] args) {
		...
		AcceptAnArrayOfstringObjectAndSortInAlphabeticalorder exe = new AcceptAnArrayOfstringObjectAndSortInAlphabeticalorder();
